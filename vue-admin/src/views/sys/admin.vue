<template>
	<div class="app-container">
		...
		<div class="filter-container">
			<el-input v-model="listQuery.username" clearable class="filter-item width-200px mr-10" :placeholder="$t('systemManagement.placeholder1')" />
		...
		<el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
			<el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon label-position="left" label-width="100px" class="dataFormClass">
				...
				<el-form-item :label="$t('systemManagement.administratorAvatar')" prop="avatar">
					<el-upload ref="upload" action="" :auto-upload="false" :show-file-list="false" :file-list="filelist" :limit="1" class="avatar-uploader" accept="image/jpg, image/jpeg, image/png, image/gif" :on-change="
                (file) => {
