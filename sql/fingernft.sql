...
--
-- Host: localhost    Database: blindbox_fingernft
-- ------------------------------------------------------
...
--
-- Table structure for table `blind_blind_box`
--

DROP TABLE IF EXISTS `blind_blind_box`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `blind_blind_box` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `blind_type_id` bigint NOT NULL DEFAULT '0' COMMENT '种类id',
  `address` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `owner` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '拥有者',
  `name` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '活动名称',
  `property` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '属性',
  `amount` int NOT NULL DEFAULT '0' COMMENT '数量',
  `nft_amount` int NOT NULL DEFAULT '0' COMMENT 'NFT数量（比如：十连抽）',
  `start_time` bigint NOT NULL DEFAULT '0' COMMENT '开始时间',
  `end_time` bigint NOT NULL DEFAULT '0' COMMENT '结束时间',
  `price` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '售价',
  `is_repetition` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否可重复（0不可重复，1可重复）',
  `img_url` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '图片路径',
  `img_id` bigint NOT NULL DEFAULT '0' COMMENT 'img_id',
  `paytoken_id` bigint NOT NULL COMMENT '支付tokenId',
  `paytoken_address` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '支付合约地址',
  `paytoken_type` int NOT NULL DEFAULT '0',
  `paytoken_name` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `paytoken_symbol` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `paytoken_token_id` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `paytoken_decimals` int NOT NULL DEFAULT '0',
  `paytoken_metadata_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `is_sync` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否上链',
  `describe` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '盒子描述',
  `anim_1` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '持续动画',
  `anim_2` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '开启动画',
  `deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '逻辑删除',
  `create_time` bigint NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` bigint NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `blind_type_id` (`blind_type_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='盲盒';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `blind_blind_box`
--

LOCK TABLES `blind_blind_box` WRITE;
/*!40000 ALTER TABLE `blind_blind_box` DISABLE KEYS */;
/*!40000 ALTER TABLE `blind_blind_box` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `blind_blind_box_order`
--

DROP TABLE IF EXISTS `blind_blind_box_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `blind_blind_box_order` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '表ID',
  `blind_box_id` bigint NOT NULL COMMENT '盲盒id',
  `owner` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '盲盒发起者',
  `sell_assets` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '盲盒NFT信息',
  `buyer_token` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '购买token信息',
  `buyer_token_id` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '购买token id',
  `buyer_type` int NOT NULL DEFAULT '0' COMMENT '购买token类型',
  `buying` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '购买token价格',
  `sellings` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '盲盒NFT个数{数字}',
  `salt` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '盐',
  `message` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `signature` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '签名',
  `opening` bigint NOT NULL DEFAULT '0' COMMENT '一次可以开多少个',
  `repeat` tinyint(1) NOT NULL COMMENT '是否可以重复',
  `openeds` bigint NOT NULL DEFAULT '0' COMMENT '已经开启次数',
  `start_time` bigint NOT NULL COMMENT '开始时间',
  `end_time` bigint NOT NULL COMMENT '结束时间',
  `uris` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'nft uri信息',
  `sellerFee` int NOT NULL DEFAULT '0',
  `buyerFee` int NOT NULL DEFAULT '0',
  `paytoken_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `paytoken_symbol` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `paytoken_decimals` int NOT NULL DEFAULT '0',
  `paytoken_metadata_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
  `create_time` bigint NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` bigint NOT NULL DEFAULT '0' COMMENT '结束时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `blind_box_id` (`blind_box_id`),
  KEY `owner` (`owner`),
  KEY `salt` (`salt`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='记录盲盒交易';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `blind_blind_box_order`
--

LOCK TABLES `blind_blind_box_order` WRITE;
/*!40000 ALTER TABLE `blind_blind_box_order` DISABLE KEYS */;
/*!40000 ALTER TABLE `blind_blind_box_order` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `blind_blind_box_to_nft`
--

DROP TABLE IF EXISTS `blind_blind_box_to_nft`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `blind_blind_box_to_nft` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `address` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `blind_box_id` bigint NOT NULL DEFAULT '0' COMMENT '盲盒id',
  `blind_nft_id` bigint NOT NULL DEFAULT '0' COMMENT '奖品id',
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `propertys` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `img_url` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `storage_id` bigint NOT NULL DEFAULT '0',
  `anim_url` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `anim_storage_id` bigint NOT NULL DEFAULT '0',
  `token_id` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '1',
  `type` int NOT NULL DEFAULT '0',
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `metadata_url` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `metadata_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `amount` int NOT NULL DEFAULT '0' COMMENT '卡片数量',
  `deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '逻辑删除',
  `create_time` bigint NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` bigint NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `blind_box_id` (`blind_box_id`),
  KEY `blind_nft_id` (`blind_nft_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='盲盒奖品配置表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `blind_blind_box_to_nft`
--

LOCK TABLES `blind_blind_box_to_nft` WRITE;
/*!40000 ALTER TABLE `blind_blind_box_to_nft` DISABLE KEYS */;
/*!40000 ALTER TABLE `blind_blind_box_to_nft` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `blind_box_history`
--

DROP TABLE IF EXISTS `blind_box_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `blind_box_history` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `owner` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '拥有者address',
  `blind_box_id` bigint NOT NULL DEFAULT '0' COMMENT '盲盒id',
  `buy_token` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '支付代币address',
  `buy_token_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '支付代币id',
  `buy_value` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '买的内容',
  `buyer` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '买的address',
  `amount` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '数量',
  `salt` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '盐',
  `nft_infos` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '开出的NFT信息',
  `paytoken_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `paytoken_symbol` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `paytoken_decimals` int NOT NULL DEFAULT '0',
  `paytoken_metadata_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `tx_hash` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT 'txHash值',
  `deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '逻辑删除',
  `create_time` bigint NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` bigint NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
--
-- Dumping data for table `blind_box_history`
--

LOCK TABLES `blind_box_history` WRITE;
/*!40000 ALTER TABLE `blind_box_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `blind_box_history` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `blind_nft`
--

DROP TABLE IF EXISTS `blind_nft`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `blind_nft` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `address` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '合约地址',
  `blind_type_id` bigint NOT NULL DEFAULT '0' COMMENT '种类id',
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '名称',
  `propertys` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '属性',
  `img_url` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '图片路径',
  `storage_id` bigint NOT NULL DEFAULT '0' COMMENT '图片在storage的id',
  `anim_url` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '视频路径',
  `anim_storage_id` bigint NOT NULL DEFAULT '0' COMMENT '图片在storage的id',
  `token_id` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0' COMMENT '所属合约的id',
  `type` int NOT NULL DEFAULT '0' COMMENT 'ETH("ETH", 0), ERC20("ERC20", 1), ERC1155("ERC1155", 2), ERC721("ERC721", 3), ERC721Deprecated("ERC721Deprecated", 4);',
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '描述',
  `is_sync` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否上链',
  `metadata_url` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '资源地址',
  `metadata_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '资源内容',
  `deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '逻辑删除',
  `create_time` bigint NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` bigint NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
--
-- Dumping data for table `blind_nft`
--

LOCK TABLES `blind_nft` WRITE;
/*!40000 ALTER TABLE `blind_nft` DISABLE KEYS */;
/*!40000 ALTER TABLE `blind_nft` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `blind_pay_token`
--

DROP TABLE IF EXISTS `blind_pay_token`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `blind_pay_token` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '表ID',
  `name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '名称',
  `symbol` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '简称',
  `type` int NOT NULL DEFAULT '1' COMMENT 'asset type  类型',
  `token` varchar(50) NOT NULL COMMENT '合约地址',
  `token_id` varchar(256) NOT NULL COMMENT 'token id',
  `decimals` int NOT NULL DEFAULT '0' COMMENT '精度',
  `rate` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '0' COMMENT '与usdt换算比例',
  `metadata_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '媒体信息',
  `deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '逻辑删除',
  `create_time` bigint NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` bigint NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `blind_pay_token`
--

LOCK TABLES `blind_pay_token` WRITE;
/*!40000 ALTER TABLE `blind_pay_token` DISABLE KEYS */;
/*!40000 ALTER TABLE `blind_pay_token` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `blind_type`
--
...
CREATE TABLE `blind_type` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '供应商名称',
  `deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '逻辑删除',
  `address` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '721合约地址',
  `create_time` bigint NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` bigint NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `address` (`address`),
...
--
-- Dumping data for table `blind_type`
--

LOCK TABLES `blind_type` WRITE;
/*!40000 ALTER TABLE `blind_type` DISABLE KEYS */;
/*!40000 ALTER TABLE `blind_type` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `fc_admin_token` VALUES (1,1,'2260bb7a-fc84-48da-a755-c2f382811b19',NULL,0,1,0,0,0,0,1649953665,1649955335);
...
INSERT INTO `fc_admin_user` VALUES (1,'','admin','admin','$2a$10$iwElLSuWI8F.iiLxqgNhIOMI0ZX0oBoifRQBF.31wZDkMWghgrPiG','127.0.0.1',1649955335,'[1]','',0,0,'','',0,0,0,1649955335);
/*!40000 ALTER TABLE `fc_admin_user` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `fc_auction_bids`
--

DROP TABLE IF EXISTS `fc_auction_bids`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `fc_auction_bids` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '表ID',
  `order_id` bigint NOT NULL DEFAULT '0' COMMENT '拍卖表ID',
  `owner` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '竞拍者',
  `buying` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '购买token价格',
  `salt` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '盐',
  `signature` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '签名',
  `status` int NOT NULL DEFAULT '0' COMMENT '状态0 无操作， 1取消， 2上链',
  `usdt_price` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT 'usdt价格',
  `bonus` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '分红',
  `deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '逻辑删除',
  `create_time` bigint NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` bigint NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
--
-- Dumping data for table `fc_auction_bids`
--

LOCK TABLES `fc_auction_bids` WRITE;
/*!40000 ALTER TABLE `fc_auction_bids` DISABLE KEYS */;
/*!40000 ALTER TABLE `fc_auction_bids` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `fc_auction_order`
--

DROP TABLE IF EXISTS `fc_auction_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `fc_auction_order` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '表ID',
  `owner` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT 'order发起者',
  `sell_token` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '售卖token地址',
  `sell_token_id` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '售卖token id',
  `sell_type` int NOT NULL COMMENT '售卖token类型',
  `sell_value` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '售卖token价格',
  `buyer_token` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '购买token地址（货币地址）',
  `buyer_token_id` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '购买token id',
  `buyer_type` int NOT NULL COMMENT '购买token类型',
  `buying` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '期望的售卖价格',
  `type` int NOT NULL DEFAULT '0',
  `start_time` bigint NOT NULL COMMENT '开始时间',
  `end_time` bigint NOT NULL COMMENT '结束时间',
  `expired_time` bigint NOT NULL COMMENT '过期时间',
  `start_value` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '起始价格',
  `range_value` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '最小加价',
  `highestPrice` varchar(50) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `salt` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '盐',
  `encourage` int NOT NULL COMMENT '分红',
  `recipients` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '分红地址',
  `signature` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '签名',
  `status_code` int NOT NULL DEFAULT '0' COMMENT '状态0 无效， 1取消拍卖，2拍卖完成，3未结算（流拍）',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否处理（0未处理， 1已处理）',
  `usdt_price` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT 'usdt价格',
  `seller_fee` int NOT NULL COMMENT '卖家手续费率',
  `buyer_fee` int NOT NULL COMMENT '买家手续费率',
  `paytoken_address` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `paytoken_name` varchar(126) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `paytoken_decimals` int NOT NULL DEFAULT '0',
  `paytoken_symbol` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '逻辑删除true 已取消，false正常',
  `create_time` bigint NOT NULL COMMENT '创建时间',
  `update_time` bigint NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `index2` (`start_time`) USING BTREE,
  KEY `index3` (`end_time`) USING BTREE,
  KEY `sell_token` (`sell_token`),
  KEY `sell_token_id` (`sell_token_id`),
  KEY `status` (`status`),
  KEY `owner` (`owner`),
  KEY `salt` (`salt`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `fc_auction_order`
--

LOCK TABLES `fc_auction_order` WRITE;
/*!40000 ALTER TABLE `fc_auction_order` DISABLE KEYS */;
/*!40000 ALTER TABLE `fc_auction_order` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `fc_block_info`
--

DROP TABLE IF EXISTS `fc_block_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `fc_block_info` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '表id',
  `block_number` bigint NOT NULL DEFAULT '0' COMMENT '区块高度',
  `block_hash` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '区块哈希',
  `timestamp` bigint NOT NULL DEFAULT '0' COMMENT '区块的时间戳',
  `deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '逻辑删除',
  `create_time` bigint NOT NULL DEFAULT '0',
  `update_time` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `block_number` (`block_number`) USING BTREE,
  KEY `timestamp` (`timestamp`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `fc_block_info`
--

LOCK TABLES `fc_block_info` WRITE;
/*!40000 ALTER TABLE `fc_block_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `fc_block_info` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `fc_contract` (
  ...
  `type` int NOT NULL DEFAULT '0' COMMENT '类型 3:ERC721 2.ERC1155',
...
CREATE TABLE `fc_contract_nft` (
  ...
  `quantity` varchar(256) NOT NULL DEFAULT '0' COMMENT '数量',
...
CREATE TABLE `fc_nft_items` (
  ...
  `sell_quantity` varchar(256) NOT NULL DEFAULT '0' COMMENT '售卖数量',
  `quantity` varchar(256) NOT NULL DEFAULT '0' COMMENT '数量',
  `signature` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '签名',
...
INSERT INTO `fc_pay_token` VALUES (1,'ETH','ETH',18,0.0000000000000000,'0x0000000000000000000000000000000000000000','/static/upload/6z9zvp2adqic1q2lmw8y.png',0,0,0,0,1648990142,1648990142),(4,'Wrapped Ether','WETH',18,0.0000000000000000,'0xc778417e063141139fce010982780140aa0cd5ab','',0,1,1,0,1649955360,1649955360);
...
--
-- Dumping events for database 'blindbox_fingernft'
--

--
-- Dumping routines for database 'blindbox_fingernft'
--
...
-- Dump completed on 2022-04-22  3:33:51
