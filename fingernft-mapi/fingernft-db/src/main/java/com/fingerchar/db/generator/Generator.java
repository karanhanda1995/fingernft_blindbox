...
public class Generator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://167.71.13.219:3306/blindbox_fingernft?useUnicode=true&useSSL=false&characterEncoding=utf8");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("fingernft");
        dsc.setPassword("Ren5!@bzys77!Ejn");
        ...
        strategy.setInclude(new String[]{
                "blind_blind_box",
                "blind_blind_box_order",
                "blind_blind_box_to_nft",
                "blind_box_history",
                "blind_nft",
                "blind_pay_token",
                "blind_type",
