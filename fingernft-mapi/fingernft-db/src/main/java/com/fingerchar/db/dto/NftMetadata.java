...
public class NftMetadata {
    ...
    public NftMetadata(BlindNft blindNft){
        this.address = blindNft.getAddress();
        this.name = blindNft.getName();
        this.description = blindNft.getDescription();
        this.storageId = blindNft.getStorageId();
        this.animUrl = blindNft.getAnimUrl();
        this.animStorageId = blindNft.getAnimStorageId();
        this.properties = blindNft.getPropertys();
    }
