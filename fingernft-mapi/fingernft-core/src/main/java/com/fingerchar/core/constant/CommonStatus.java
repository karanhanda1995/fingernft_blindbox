...
public enum CommonStatus {
	...
	CANCEL_AUCTION("Cancel auction", 20), CANCEL_AUCTION_BID("CancelAuctionBid", 21), SUCCESSFUL_TRADE("Successful trade", 22),
	ABORTED("Aborted", 23), AUCTION_BONUS("AuctionBonus", 24),
	AUCTION("Auction", 25), EDIT_AUCTION("EditAuction", 26),
	AUCTION_BID("AuctionBid", 27), AUCTION_BUY("AuctionBuy", 28),
