        ...
        for (FcSystem item : systemList) {
            ...
            switch (item.getKeyName()){
                ...
                case SysConfConstant.WEBSITE:
                    ...
                    break;
                case SysConfConstant.AUCTION_EXPIRE_TIME:
                    fetchVo.setAuctionExpireTime(item.getKeyValue());
                    break;
                ...
                case SysConfConstant.CONFIG_CONTRACT:
                    ...
                    configContract.setAuctionStateAddress(null);
                    configContract.setBlindStateAddress(null);
                    configContract.setCopyErc721Address(null);
                    configContract.setNft721Address(null);
                    configContract.setNft1155Address(null);
