...
public class FcOrderController extends BaseController {
	...
	public Object buyPrepare(PrepareOrderInfo order) throws Exception {
		if((StringUtils.isEmpty(order.getBuyToken()) || null == order.getBuyTokenId() || StringUtils.isEmpty(order.getOwner()) || StringUtils.isEmpty(order.getSalt()) || null == order.getType())
		&&((StringUtils.isEmpty(order.getSellToken()) || null == order.getSellTokenId() || StringUtils.isEmpty(order.getOwner()) || StringUtils.isEmpty(order.getSalt()) || null == order.getType()))
		) {
