...
public class Erc721EventService extends baseEventService{
    ...
    private void processTransferEvent(EventValuesExt eventValues) throws Exception {
        ...
        TransferLog log = new TransferLog(eventValues.getAddress(), tokenId, from, to, new BigInteger("1"), eventValues.getTxHash(), eventValues.getBlockTimestamp(), eventValues.getBlockNumber().longValue());
