<template>
  <div class="main-wrapper">
    <div class="g-main flex">
      ...
      <auction-detail-dialog :show="showAuctionDetailDialog" @close="closeDialog" @confirm="dialogConfirm" :token="dialogToken" :auction="dialogOrder" :uri="dialogNftURI" :nft="dialogNft"></auction-detail-dialog>
