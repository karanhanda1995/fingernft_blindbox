<template>
  ...
  <div class="body-wrapper">
    <div class="carousel-section">
      <el-carousel id="home-banner" class="home-banner"  :interval="6000" :height="bannerHeight">
        <el-carousel-item v-for="(banner, i) in banners" :key="i">
          <div class="banner-box">
            <div class="banner-content">
              <div class="banner-name" style="color:#fff;">Buy and sell digital art <br/>
              NFT collection</div>
              <div class="banner-title"></div><br><br>
              <div class="banner-text">MusicTrust is a marketplace to get quality music albums NFTs</div><br>

<div style="padding: 20px 0 0px 0px;">
<router-link class="btn btn-primary"
          :class="$route.name == 'Items' ? 'active' : ''"
          :to="!connected ? '/connect' : '/items'"
        style="margin-right:15px; font-size: 20px; padding: 11px 23px !important;">
          Profile
        </router-link>

        <router-link class="btn btn-white" to="/create" style="font-size: 20px; padding: 11px 23px !important; background-color: #fff;">
           ...
           Upload Item
            ...
            <div class="banner-img">
              <img :src="require('@/assets/img/hero_back.png')" />
            </div>
          </div>
        </el-carousel-item>
      </el-carousel>
                ...
                <div class="row justify-content-center mb-20_reset">
                    <div class="col-md-3">
                        <div class="item space-y-10">
                            <div class="logo">
                                <img :src="require('@/assets/img/icons/github.svg')"
                                     alt="logo_community">
                            </div>
                            <h5 class="text-center" style="font-size: 18px;font-weight: bold;">Github</h5>
                    ...
                    <div class="col-md-3">
                        <div class="item space-y-10">
                            ...
                            <h5 class="text-center" style="font-size: 18px;font-weight: bold;">Twitter</h5>
                            <p class="text-center">Understand the progress of our
                                code and project</p>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="item space-y-10">
                            ...
                            <h5 class="text-center" style="font-size: 18px;font-weight: bold;">Discord</h5>
                            <p class="text-center">Understand the progress of our
                                code and project</p>
                        </div>
                    </div>
