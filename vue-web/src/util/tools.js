...
export default {
  ...
  getAuctionStatus(type) {
    return AUCTION_STATUS[type];
  },
  getAuctionStatusCode(code) {
    return AUCTION_STATUS_CODE[code];
  },
  ...
  singlePrice(price, quanlity, payToken) {
    ...
    value = value.dividedBy(new BigNumber(quanlity)).toFixed(10);
  ...
  decimalsValue(value, quanlity, decimals) {
    ...
    value = value
      .multipliedBy(new BigNumber(quanlity))
  ...
  noDecimalsValue(value, quanlity, decimals) {
    value = new BigNumber(value);
    value = value
      .dividedBy(new BigNumber(quanlity))
      .dividedBy(new BigNumber(10).exponentiatedBy(new BigNumber(decimals)))
      .toFixed();
    return value;
  },
  BigNumberPlus(a, b){
  ...
  BigNumberDivide(a, b){
    return new BigNumber(a).dividedBy(new BigNumber(b)).toFixed();
  },
  BigNumberMinu(a, b){
